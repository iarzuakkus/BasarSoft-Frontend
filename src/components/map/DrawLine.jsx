...
/**
 * LineString çizimi – çoklu vertex, canlı segment görünümü.
 * Bitirme: Double-Click veya Enter
 * Undo: Backspace/Delete
 * İptal: Esc
 */
export default function DrawLine({ map, sketchSource, onWkt }) {
  ...
  useEffect(() => {
    ...
    draw.on("drawstart", (evt) => {
      ...
      const push = () => onWkt?.(writeWkt(geom)); // 4326 olarak yaz
      geom.on("change", push);
      push();
    });
